# RailsAdmin config file. Generated on May 30, 2013 18:57
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Startupality', 'Admin']
  ...
  # config.excluded_models = ['Post', 'Project', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Post', 'Project', 'User']
